// MSDNLanguageFilter
// version 0.2
// 2005-04-12 (last update: 2006-01-30)
...
// update (2006-01-30):
// Fixed for Greasemonkey 0.6.4 on Firefox 1.5
...
+ 
            "<a id='configJS' onclick='return ToggleOption(\"configJS\");' href='#'>JScript</a>" + 
separator + 
...
unsafeWindow.ToggleOption = function(id) 
{
    ...
    var rightFrameXPathRes = document.evaluate(xpathRightFrame, parent.document, null, 
XPathResult.ANY_UNORDERED_NODE_TYPE, null);
    ...
    var contentFrameXPathRes = document.evaluate(xpathContentFrame, 
rightFrameXPathRes.singleNodeValue.contentDocument, null, XPathResult.ANY_UNORDERED_NODE_TYPE, null);
