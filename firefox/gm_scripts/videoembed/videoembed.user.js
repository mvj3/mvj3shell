...
var defaultSites = [
	...
	{
		n:'Gamevee',
		l:'^http://([a-zA-Z0-9]+\.|)gamevee\.com/viewVideo/([a-zA-Z0-9]+)',
		args:[
			['match','/viewVideo/([a-zA-Z0-9]+)',1],
			],
		width:480,
		height:420,
		embed:'http://www.gamevee.com/public/gameveeplayer.swf?video_id={0}&embed=on&vidview=on',
	},
	{
		n:'Google',
	...
	},
	{
		...
		width:480,
		height:392,
		embed:'http://www.gametrailers.com/remote_wrap.php?umid={0}',
	},
	{
		n:'Pikniktube',
	...
	{
		n:'Ustream',
		l:'^http://([a-zA-Z0-9]+\.|)ustream\.tv.+([0-9]+)',
		args:[
...
function checkupd(){
	...
	GM_xmlhttpRequest({
		...
		onload:function(result) {
			if (result.responseText.indexOf('@version        5.06') == -1) {
