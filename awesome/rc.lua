...
apptags =
{
    ...
    ["amule"] = { screen = 1, tag = 9 },
    ["soffice"] = { screen = 1, tag = 3 },
    ["mysql-query-browser"] = { screen = 1, tag = 4 },
...
for s = 1, screen.count() do
    ...
    tags[s] = {}
    tags[s][1] = tag("web & editor")
    tags[s][2] = tag("console")
    tags[s][3] = tag("documents")
    tags[s][4] = tag("sql")
    tags[s][5] = tag("email")
    tags[s][6] = tag("6")
    tags[s][7] = tag("im")
...
awful.hooks.timer.register(60, function ()
    mytextbox.text = os.date(" %a %b %d, %H:%M ") .. screen.count()
    -- mytextbox.text = screen.count()
end)
-- }}}
...
os.execute("stardict &")
os.execute("gnome-appearance-properties &")
